...
<body>
    ...
    <div class="jumbotron jumbotron-fluid page-header" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Nuestro Colegio</h1>
            <div class="d-inline-flex align-items-center text-white">
                <p class="m-0"> La Jose Miguel es Mía</a></p>
                <i class="fa fa-circle px-3"></i>
                <p class="m-0">Yo soy de la Jose Miguel</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="section-title position-relative text-center mb-5">Página en construcción</h1>
                </div>
            </div>
                    ...
                    <div class="owl-carousel service-carousel">
                        ...
                        <div class="service-item">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                ...
                                <p>"No somos Humanos por haber nacido humano, nos hacemos Humanos a medida que nos relacionamos con el otro". <br> Kant.</p>
