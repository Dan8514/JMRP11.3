                                            ...
                                            <table name="usuarios" id="usuarios" class="table table-striped" style="width:95%">
                                                        ...
                                                        <?php foreach($usuarios as $usuario) {?>
                                                            <tr>
                                                                ...
                                                                <td> <?php
                                                                    if(strpos($usuario['foto'], '<svg') !== false){
                                                                        echo '<div style="width:50px; height:50px; display:inline-block;">' . $usuario['foto'] . '</div>';
                                                                    } else {
                                                                        echo '<img class="circulo" src="data:image/jpg;base64,' . base64_encode($usuario['foto']) . '" width="50px" height="50px"/>';
                                                                    } ?> </td>                                                                <td><center><button type="button" class="btn btn-md btn-warning" id="editaru" nombre="editaru" data-bs-toggle="modal" data-bs-target="#modaleditaru<?php echo $usuario['id_usu'];?>"><i class="fa-solid fa-pen-to-square"></i></button></center></td>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div style="position:relative;">
                                            <input type="password" name="clave" id="password" class="form-control" style="padding-right:40px;">
                                            <button type="button" onclick="togglePass('password')" 
                                                ...
                                                <i class="fa-solid fa-eye" id="icon-clave"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div style="position:relative;">
                                            <input type="password" name="clave2" id="password2" class="form-control" style="padding-right:40px;">
                                            <button type="button" onclick="togglePass('password2')"
                                                style="position:absolute; right:8px; top:50%; transform:translateY(-50%); background:none; border:none; cursor:pointer;">
                                                <i class="fa-solid fa-eye" id="icon-clave2"></i>
                                            </button>
                                        </div>
                                    </div>
                                            <div class="col">
                                                ...
                                                <select type="text" name="tipo" id="tipo" class="form-select">
                                                    <option value="0">Usuario Tipo 2</option>
